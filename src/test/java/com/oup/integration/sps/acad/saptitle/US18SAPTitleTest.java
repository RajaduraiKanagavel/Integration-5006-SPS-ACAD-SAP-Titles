...
public class US18SAPTitleTest {
	...
	public void setUp() throws Exception {
		...
		camelContext.getRouteDefinition("sapTitleSchedulerRouteUS").autoStartup(true).routePolicyRef(null);
		camelContext.start();
	}
	...
	private void validateMessage(Exchange exchange, List<SAPTitleBiblio> aggregatedList) {
		...
		assertThat("Wrong sequence number or date", firstrow,
				startsWith("us180001 " + new SimpleDateFormat("ddMMyyyy").format(new Date()) + " "));
